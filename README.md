...
# サービス開発の経緯
サービス作成のきっかけは愛犬が病気を患ったことです。進行性の病だったため、今思えば前兆はあったものの知識や情報がなく、発見が遅れてしまい大きな手術が必要になりました。
<br>

愛犬のために手術や術後のケアを調べるものの、見つかるのは学術的なものばかりで、私が求めていた「実際の病気の症状」や「術後のケア方法」といったリアルな体験談を見つけ出すことが出来ませんでした。また、こういった不安な気持ちを共有したり、相談したりできる環境がなく気が休まらない日々を過ごしました。<br>
<br>
この経験から、日頃の愛犬の様子を手軽に記録できるだけでなく、他のユーザーの体験談をもとに病気の早期発見をサポートしたり、ペットオーナー同士の心の拠り所となるようなサービスを作りたいと考え、このアプリを開発しました。
...
# システム構成図
![Image](https://github.com/user-attachments/assets/5fe75bf2-35c8-4f31-9e4e-b66208eb6fd7)

# ER図
![Image](https://github.com/user-attachments/assets/3f17922c-3411-4469-9ae4-623dd759edcb)

# 今後の展望
今後は以下のフェーズに分けて、開発を進めていきたいと考えています。
### フェーズ1: UI/UXの強化
よりユーザー体験を向上させるための改善を行います。既存UIの配置や機能名の見直しを行い、初見でも操作に迷わないようなデザインに改修します。<br>

### フェーズ2: 新機能の追加
実際にサービスを使用してもらったユーザーの要望、フィードバックを基に新たな機能追加を行います。<br>
直近では複数の愛犬情報を追加できるように改修したり、家族間で愛犬情報を共有できるシェア機能を追加したいと考えています。

### フェーズ3: パフォーマンスの向上
サービス全体のシステムパフォーマンス向上を目指します。データの読み込みやアップロード時のレスポンス時間を短縮し、ユーザーがスムーズにサービス利用できるようにします。
